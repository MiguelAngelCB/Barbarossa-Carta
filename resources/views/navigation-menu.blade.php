<nav x-data="{ open: false }" class="bg-black border-b border-gray-100">
    ...
    <div class="inline-flex items-center">
            <a
                href="{{ route('login') }}"
                class="px-1 pt-1 border-b-2 border-transparent text-lg font-medium leading-5 text-red-500 hover:text-red-700 focus:outline-none focus:text-red-700 transition duration-150 ease-in-out mx-2"
            >
                Log in
            </a>
